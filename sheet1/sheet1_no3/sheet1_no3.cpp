      ...
      while (ch!= EOF)
            {
             ...
             date_of_birth[i]='\0';
             strcpy(stud.date_of_birth,date_of_birth);
             ...
             place_of_birth[i]='\0';
             strcpy(stud.place_of_birth,place_of_birth);
         ...
         for (n=0;n<no_records_placedin_buffer;n++)
             {
              ...
              printf("%s ",buffer[n].date_of_birth);
              printf("%s ",buffer[n].place_of_birth);
             }
         i++;
       }
    getch();
        ...
        switch (choice)
          {
           ...
           case 3: DeleteSeqOrdered(master_handler,master,trans_handler,count_trans_records,count_deleted_records);
                   break;
           case 4: merge_func(master_handler,master,trans_handler,count_trans_records,count_deleted_records);
                   break;
        ...
        switch (choice)
          {
           ...
           case 3: DeleteDirectUnordered(master_handler,master,directory_handler,directory,count_deleted_records);
                   break;
           case 4: OrganizeDirectUnordered(master_handler,master,directory_handler,directory,count_deleted_records);
                   break;
